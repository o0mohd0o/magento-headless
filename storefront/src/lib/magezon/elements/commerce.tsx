...
/** Element types this adapter is registered for. Defined in a non-client module
 * (commerce-types) so server code can read it; re-exported here for convenience. */
export { COMMERCE_TYPES } from './commerce-types';
