...
// COMMERCE_TYPES comes from the non-client module so this (server-evaluated)
// bootstrap can read it as real data; CommerceElement is the client component.
import { CommerceElement } from './elements/commerce';
import { COMMERCE_TYPES } from './elements/commerce-types';
